  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Upworx: Empowering Owners, Recruiters and Freelancers - manage company accounts, job offers, applications and contracts seamlessly in one platform."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Upworx: Empowering Owners, Recruiters and Freelancers - manage company accounts, job offers, applications and contracts seamlessly in one platform.`}
            </Text>
            <Box
